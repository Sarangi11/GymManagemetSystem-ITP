...
import workoutplan  from "../models/Twodayworkout.js" ;
...
router.route("/update/:id").put(async (req, res) => {
    try {
        ...
        const { Email, CustomerId, Gender, exercises1, exercises2 } = req.body; // Extract Email, CustomerId, Gender from req.body
        ...
        await workoutplan.findByIdAndUpdate(workoutId, { Email, CustomerId, Gender, exercises1, exercises2 }); // Include Email, CustomerId, Gender in the update
